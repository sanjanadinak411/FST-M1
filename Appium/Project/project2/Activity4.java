	...
	public void method4() throws InterruptedException{
		...
		for (String contextName : contexts) {
		    ...
		    if (contextName.contains("WEBVIEW")) {
		    	...
		    	//wait1.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//div[@id='popup']")));
		        driver1.switchTo().activeElement().findElement(AppiumBy.xpath("//div[@id='popup']")).click();
		        //driver1.switchTo().activeElement();
		        //.findElement(AppiumBy.id("popup"));
		        //driver1.findElement(AppiumBy.xpath("//div[@id='popup']"));
		        //.findElement(AppiumBy.xpath("//div[@id='popup']")).click();
		        
		        //wait1.until(ExpectedConditions.presenceOfElementLocated(AppiumBy.xpath("//form[@id='signInForm']")));
